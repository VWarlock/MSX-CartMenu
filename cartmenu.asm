...
;        0 selects Size 0 sprites (8 õ 8 bit)
;        1 selects Size 1 sprites (16 õ 16 bits)
;    Bit 0:  MAG (Magnification option for sprites)
;        Î selects MAGO sprites (1 Õ)
...
;-------------------- DATA Section ------------------------
; Message data
WelcomeStr1:	DB "Texas Instrument VDP TMS9918/28",0	; Zero indicates the end of text
WelcomeStr2:	DB "VIDEO DISPLAY (32X24 Patterns).",0
WelcomeStr3:	DB "Graphics I Mode",7Fh,0
; Menu entries	
